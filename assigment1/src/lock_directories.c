...
void lock_directories() {
	...
	if(pid == -1) { 
		...
		char *upload_dir = "/workspaces/system-software-1/assigment1/managers_xml_upload";
		char *dashboard_dir = "/workspaces/system-software-1/assigment1/dashboard_system";
